...
# 润色专用提示词
POLISH_SYSTEM_PROMPT = BASE_SYSTEM_PROMPT + """

## 润色任务说明

你需要对教学课件页面进行文字润色，使表达更加流畅、准确、专业。
...
# 扩展专用提示词
EXPAND_SYSTEM_PROMPT = BASE_SYSTEM_PROMPT + """

## 扩展任务说明

你需要对教学课件页面进行内容扩展，增加更多细节、例子或解释。
...
# 改写专用提示词
REWRITE_SYSTEM_PROMPT = BASE_SYSTEM_PROMPT + """

## 改写任务说明

你需要对教学课件页面进行风格改写，调整语言表达方式以适应不同的教学场景。
...
# 提取专用提示词
EXTRACT_SYSTEM_PROMPT = BASE_SYSTEM_PROMPT + """

## 提取任务说明

你需要从教学课件页面中提取知识点，总结关键信息。
